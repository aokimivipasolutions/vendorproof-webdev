jQuery(function($){
  ...
  {
    return jQuery("button:contains('New Location'):disabled").length == 1
        || jQuery(".client-location-column button:contains('Save')").length == 1;
  }
  ...
  {
  	jQuery("<div>Before making any edits to the <b>Remittance Address List</b> or "
        + "<b>Purchasing Contact List</b> save or cancel your changes.</div>")
      .dialog({
        modal: true,
